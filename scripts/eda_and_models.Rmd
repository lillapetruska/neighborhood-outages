...
The TPR of the baseline model is about 0.049
...
Major goal is to increase True Positive Rate (which is about 0.05 for the 
baseline model). TPR is equivalent to the Sensitivity.

### Final model (K-nearest neighbors algorithm)
